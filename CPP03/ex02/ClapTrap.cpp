...
{
	std::cout << _name << ": ClapTrap Default constructor called" << endl;
}

ClapTrap::ClapTrap(std::string& name) : _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0)
{
	std::cout << _name << ": ClapTrap String constructor called" << endl;
}

ClapTrap::ClapTrap(const ClapTrap& other)
{
	std::cout << "ClapTrap Copy constructor called" << endl;
	*this = other;
}

ClapTrap::~ClapTrap(void)
{
	std::cout << _name << ": ClapTrap Default destructor called" << endl;
}

ClapTrap& ClapTrap::operator = (const ClapTrap& other)
{
	std::cout << "ClapTrap Copy assignment operator called" << endl;
	if (this != &other)
	{
